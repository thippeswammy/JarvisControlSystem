...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        ...
        steps=[
            ...
            Step("click format",                 wait=1.0,  description="Click Format menu"),
    ...
    Scenario(
        ...
        steps=[
            ...
            Step("open notepad",                 wait=2.5,  description="Open Notepad"),
            Step("click format",                 wait=1.0,  description="Click Format menu"),
            Step("click word wrap",              wait=1.0,  description="Toggle Word Wrap"),
            Step("click format",                 wait=1.0,  description="Click Format again"),
            Step("click word wrap",              wait=1.0,  description="Toggle back"),
