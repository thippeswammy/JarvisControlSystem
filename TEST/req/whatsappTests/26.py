...
# Iterate through the list of elements and find the chat input field
for element in whatsapp_window.descendants(control_type='Edit'):
    if element.wrapper_object().control_type == 'Edit':
        chat_input = element
        break
