...
Run:
    python -m jarvis.memory.migration
"""
...
_DB_DEFAULT = str(_MEMORY_V1_DIR / "jarvis.db")
...
if __name__ == "__main__":
    ...
    print("  python -c \"from jarvis.memory.graph_db import GraphDB; "
          "db = GraphDB('./memory/jarvis.db'); print(db.list_apps())\"")
