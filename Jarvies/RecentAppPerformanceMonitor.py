...
from Data.JSON_Information_Center import AddDate

FileName = r"..\Data\Data_Information_Value/RecentAppName"
...
def RecentAppPerformanceMonitorFun():
    ...
    if new_apps:
        directory = r'..\TEST\completed'
        if not os.path.exists(directory):
            os.makedirs(directory)

        with open('../TEST/completed/newly_opened_apps45.txt', 'a') as file:
        ...
        with open('../TEST/completed/newly_opened_apps54.txt', 'a') as file:
